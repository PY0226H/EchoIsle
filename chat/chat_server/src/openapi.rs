...
use crate::{
    ...
    GetJudgeDispatchMetricsOutput, GetJudgeReportOutput, GetJudgeReportQuery, IapProduct,
...
#[openapi(
        ...
        components(
            schemas(
                ...
                JudgeRagSourceItem, JudgeRagMeta, JudgeStageSummaryDetail, JudgeReportDetail,
                GetJudgeReportOutput,
